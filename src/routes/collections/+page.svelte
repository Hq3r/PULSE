<script lang="ts">
	import Explore from '$lib/components/collections/Collections.svelte';
...
{#if showModal}
	<SellModal on:close={toggleModal} />
{/if}
...
<!-- Floating Action Button (FAB) and Options -->
<div class="fab-container">
	<div
		class="btn btn-primary py-[15px] border-0 px-[30px]"
